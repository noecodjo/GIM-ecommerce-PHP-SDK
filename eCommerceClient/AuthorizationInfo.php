...
class AuthorizationInfo
{
    ...
    /**
     * @var string $TxtCardNo
     */
    protected $TxtCardNo = null;
    ...
    /**
     * @var ArrayOfThreeDSecureItem $ThreeDSecure
     */
    protected $ThreeDSecure = null;
     ...
     * @param ArrayOfThreeDSecureItem $ThreeDSecure
     */
    public function __construct($Version, $AuthorType, $OrderId, $TxtCardNo, $CardExpiryMonth, $CardExpiryYear, $EffectiveDate, $CVV2, $TokenAction, $TokenValue, $PurchaseDesc, $PurchaseAmount, $FeesAmount, $PurchaseCurrency, $CaptureFlag, $ShippingFirstName, $ShippingMiddleName, $ShippingLastName, $ShippingAddress1, $ShippingAddress2, $ShippingCityCode, $ShippingState, $ShippingZipcode, $ShippingCountry, $ShippingEmail, $ShippingPhone, $ShippingFax, $ShippingMobilePhone, $ShippingMethod, $BillingFirstName, $BillingMiddleName, $BillingLastName, $BillingAddress1, $BillingAddress2, $BillingCity, $BillingState, $BillingZipcode, $BillingCountry, $BillingEmail, $BillingPhone, $BillingFax, $BillingMobilePhone, $SignatureMethod, $Signature, $ScheduledPayment, $ScheduledTermCaptureFlag, $NbOfInstallment, $InstallmentFrequency, $InstallmentNextDate, $NbOfRecurring, $RecurringFrequency, $RecurringAmount, $RecurringFeesAmount, $RecurringStartDate, $ExecutionDate, $ProcessorAcquirerId, $OriginOutletUrl, $TestFlag, $CardHolderName, $AcronymDescriptor, $OrderDetailPresent, $CustomerId, $ItemsPresent, $NbOfItems, $OrderItems, $ShippingCost, $VatIncluded, $VatCost, $DeliveryDate, $AdditionalDetailsPresents, $NbOfFields, $AdditionalFields, $UpdateIndicator, $PassengerName, $CustomerCode, $IssueDate, $TravelAgencyCode, $TravelAgencyName, $TicketNumber, $IssuingCarrier, $TotalFare, $TotalTax, $NationalTax, $ThreeDSecure)
    {
     ...
     * @return AuthorizationInfo
     */
    public function setTxtCardNo($TxtCardNo)
    {
      $this->TxtCardNo = $TxtCardNo;
      return $this;
    }
